...
const Etoile = () => {
  ...
  const getLang = (lang) => {
    switch (lang) {
      case "en":
        return en_tr.saudi_project_etoile;
      case "ru":
        return ru_tr.saudi_project_etoile;
      case "ch":
        return ch_tr.saudi_project_etoile;
      default:
        return en_tr.saudi_project_etoile;
    }
  };
            ...
            <div className="col-lg-12">
              <div className="about-page-img">
                <Image
                  ...
                  src="/images/etoile/DAAR.Terrace.webp"
                  alt="about banner"
                />
              </div>
            </div>
