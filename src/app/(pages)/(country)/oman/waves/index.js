...
const AlMoujHills = () => {
  ...
  const getLang = (lang) => {
    switch (lang) {
      case "en":
        return en_tr.oman_projects_waves;
      case "ru":
        return ru_tr.oman_projects_waves;
      case "ch":
        return ch_tr.oman_projects_waves;
      default:
        return en_tr.oman_projects_waves;
    }
  };
  ...
  return (
    <>
      ...
      <section className="waves p-0 ">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcumb-style1">
                <h2 className="pl15 title fz40">
                  Al Mouj Muscat, Muscat Hills
                  {/* <Image
                    width={400}
                    height={50}
            ...
            <div className="col-lg-12">
              <div className="about-page-img">
                <Image
                  ...
                  src="/images/al-mouj-oman/waves-02.jpg"
                  alt="about banner"
                />
              </div>
            </div>
