...
const Marea = () => {
  ...
  const getLang = (lang) => {
    switch (lang) {
      case "en":
        return en_tr.spain_project_marea;
      case "ru":
        return ru_tr.spain_project_marea;
      case "ch":
        return ch_tr.spain_project_marea;
      default:
        return en_tr.spain_project_marea;
    }
  };
            ...
            <div className="col-lg-12">
              <div className="about-page-img">
                <Image
                  ...
                  src="/images/marea/DG.MAREA_Aerial 1.webp"
                  alt="about banner"
                />
              </div>
            </div>
