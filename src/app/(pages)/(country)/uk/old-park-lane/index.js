...
const OldParkLane = () => {
  ...
  const getLang = (lang) => {
    switch (lang) {
      case "en":
        return en_tr.uk_project_old_park_lane;
      case "ru":
        return ru_tr.uk_project_old_park_lane;
      case "ch":
        return ch_tr.uk_project_old_park_lane;
      default:
        return en_tr.uk_project_old_park_lane;
    }
  };
  ...
  return (
    <>
      ...
      <section className="old_park_lane p-0 ">
            ...
            <div className="col-lg-12">
              <div className="about-page-img">
                <Image
                  ...
                  src="/images/old-park-lane/149OPL_Entrance.webp"
                  alt="about banner"
                />
              </div>
            </div>
