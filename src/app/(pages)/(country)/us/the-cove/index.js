...
const TheCove = () => {
  ...
  const getLang = (lang) => {
    switch (lang) {
      case "en":
        return en_tr.us_project_the_cove;
      case "ru":
        return ru_tr.us_project_the_cove;
      case "ch":
        return ch_tr.us_project_the_cove;
      default:
        return en_tr.us_project_the_cove;
    }
  };
  ...
  return (
    <>
      ...
      <section className="the_cove p-0 ">
            ...
            <div className="col-lg-12">
              <div className="about-page-img">
                <Image
                  ...
                  src="/images/the-cove/img-2.webp"
                  alt="about banner"
                />
              </div>
            </div>
