          ...
          <div className="row" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="col-lg-6">
              ...
              <p className="text mb-1">
                Cyprus’ southern coastal city of Limassol has blossomed over the
                last few decades from an industrial-fuelled landscape into a
                multifaceted, modern European vista of vibrant opportunities in
                business, culture, and recreation.
              </p>
              <p className="text mb-1">
                Reigning supreme as the epitome of luxurious island living,
                Limassol’s coastal charm, inherent history and culture, vast
                entertainment options, boutique shopping, and epicurean
                proposals make it a playground for global, glamorous travellers
                and residents alike.
              </p>
              <p className="text mb-1">
                Armed with rich knowledge of Limassol’s development history and
                belief in the potential of its future, Pafilia saw an
              ...
              <p className="text mb-1">
                ...
                transform the character of a city’s landscape, and the essence
                of a community’s experience, Pafilia sought out the most
                esteemed consortium of partners – including Atkins, of Burj Al
                Arab fame, WKK, HBA, and BuroHappold – with which to collaborate
                in orchestrating the exact execution of its vision for ONE.
              </p>
              <p className="text mb50">
                ...
                town is Limassol’s most iconic address. In possession of a prime
                position along it, Pafilia set about uniting Limassol’s blessed
                trinity of city, mountain, and sea, creating an immediately
                recognisable 37-storey landmark to command the locale’s horizon.
              </p>
