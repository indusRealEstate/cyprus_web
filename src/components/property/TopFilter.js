...
import { includes } from '@/data/mobileMenuItems';
...
const TopFilter = ({ filterFunctions }) => {
	const getSearchVal = (value) => {
		const search = filterFunctions.setSearchQuery(value);
		const searchText = filterFunctions.searchText(value);
	};
	return (
		<>
					...
					<div className='d-sm-flex'>
						<div className='position-relative mb10 mr10'>
							<input
								...
								onChange={(e) => getSearchVal(e.target.value)}
